...
u8= in Zig), we check if the character is =\n=, and if it is, we reset
=column= to 0 and increment =row= by one. Otherwise, we calculate the correct
...
are called =inb= and =outb= in assembly. =inb= is for reading a byte, while
=outb= is for writing a byte to some port. We will define these functions
in =src/utils.zig=:
...
os
├── src
│   ├── <a href="../console-graphics/os/src/Console.zig">Console.zig</a>
│   ├── <a href="../console-graphics/os/src/main.zig">main.zig</a>
│   └── <a href="../console-graphics/os/src/utils.zig">utils.zig</a>
├── <a href="../console-graphics/os/build.zig">build.zig</a>
└── <a href="../console-graphics/os/linker.ld">linker.ld</a>
</pre>
#+END_EXPORT
